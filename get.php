...
if (isset($_POST["reg"])) {
    ...
    if ($result->num_rows > 0) {
        ...
        // Extract data from the row and convert to uppercase
        $Name = strtoupper($row["Name"]);
        $Phone = strtoupper($row["Phone_number"]);
...
<section id="form">
    ...
    <fieldset>
        <form method="post">
            <input type="text" name="reg" placeholder="Enter Registration Number" required="text">
            <br><br>
